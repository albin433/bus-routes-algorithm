...
function TableBusIcon({ visitedStops, index }) {
    const [busColor, setBusColor] = useState('');
    useEffect(() => {
        const getRandomColor = () => {
            const colors = ['red', 'blue', 'violet', 'grey', 'yellow', 'green'];
            setBusColor(colors[index]);
        };
    ...
    return (
        <React.Fragment key={index}>
            {index !== visitedStops.length - 1 && (
                <div className="svgja-tabel" style={{ width: '190px', height: '30px' }}>
                    <div className="col-6 h-100">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 300" xmlSpace="preserve" fill={busColor} >
